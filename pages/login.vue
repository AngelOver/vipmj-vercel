<template>
    <div class="login_reg_portal">
        <div class="logo flex align-items-center">
            <img :src="counter.setting.logo" alt="">
            <h5 class="mb-0 ml-1">{{counter.setting.title}}</h5>
        </div>
        <a-modal
            ...
            <a-row :gutter="20">
                ...
                <a-col span="12">
                    <div class="form_right">
                        ...
                        <!--register-->
                        <div v-else class="card register_card pt-3 border-0">
                            <div class="card-body">
                                <img src="@/assets/images/safe_login.png" alt="" class="w-28 m-auto mb-2">
