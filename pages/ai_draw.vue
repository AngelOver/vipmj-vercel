<template>
    ...
    >
                        ...
                        <div class="mt-2 fade-box draw_des_clip">
                            <section
                                ...
                                <a-textarea
                                    ...
                                    type="textarea"
                                    :max-length="{length:2000,errorOnly:true}"
                                    show-word-limit
                                    allow-clear
                                    placeholder="请用英文输入Prompt，参考形式：画面主体，细节描述，修饰词"
                                />
                                <div class="des_check flex position-absolute left-2 bottom-3 cursor-pointer">
                                    <a-trigger :popup-translate="[100, 0]" position="bottom" auto-fit-position :unmount-on-close="false">
                                        <div>
                                            <icon-relation />
                                            联想
                                        </div>
        ...
        <div
            ...
            <div class="flex mb-2">
                ...
                消耗额度：{{ activeDraw=='midj'?mj_midj:ai_draw_pay }}/次
            </div>
    ...
    <div class="main draw_main_content">
        <div class="editor-panel bg-ai">
            <div class="editor-panel__right-panel">
                                        ...
                                        <div class="generate-area-pc__content">
                                            <div class="generate-card generate-card--generated flex-column overflow-hidden">
                                                ...
                                                class="generate-card__result-img rounded-xl ">
                                                    <template #extra>
                                                        <div class="round_bottom" v-if="now_draw.type=='midjourney'|| now_draw.type=='midjourney_up'">
                                                ...
                                                <div class="generate_result flex justify-content-between w-100 mt-4">
                                                    <div class="generate_result_left">
                                                        <a-space class="mb-2">
                                                            <a-button class="bg-white" @click="input2=now_draw.title">
                                                                <template #icon>
                                                                    <icon-edit />
                                                                </template>
                                                                复用参数
                                            ...
                                            <a-image
                                                @click="get_choose_index(m.id)"
                                                  ...
                                                  justifyContent: 'center',
                                                     ...
                                                     :src="m.image?m.image:m.no_img" class="mb-1 overflow-hidden rounded-xl">
                                                <template #loader>
                                                    <img
                                                        class="h-full p-3"
                ...
                <!--<div class="all_generate_me p-4 pb-20">-->
                <!--    <client-only>-->
                ...
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!--                                    <div class="v_zoom  pl-2 mb-2" v-if="m.type=='midjourney_up'">-->
                <!--                                        <div class="flex flex-wrap">-->
                <!--                                            <span>精细：</span>-->
                <!--                                            <a-button size="mini"-->
                <!--                                                      @click="vary_image_midj(m.title,m.prompt_id,m.message_id,'0')"-->
                <!--                                                      :disabled="up_loading"-->
                <!--                                                      class="mr-4 cursor-pointer mb-2 w-30">-->
                <!--                                                V(Strong)-->
                <!--                                            </a-button>-->
                <!--                                            <a-button size="mini"-->
                <!--                                                      @click="vary_image_midj(m.title,m.prompt_id,m.message_id,'1')"-->
                <!--                                                      :disabled="up_loading"-->
                <!--                                                      class="mr-4 cursor-pointer mb-2 w-30">-->
                <!--                                                V(Subtle)-->
                <!--                                            </a-button>-->
                ...
                <!--                                            <span>缩放：</span>-->
                <!--                                            <a-button size="mini"-->
                <!--                                                      @click="zoom_image_midj(m.title,m.prompt_id,m.message_id,'0')"-->
                <!--                                                      :disabled="up_loading"-->
                <!--                                                      class="mr-4 cursor-pointer mb-2 w-30">-->
                <!--                                                Zoom(2.0x)-->
                <!--                                            </a-button>-->
                <!--                                            <a-button size="mini"-->
                <!--                                                      @click="zoom_image_midj(m.title,m.prompt_id,m.message_id,'1')"-->
                <!--                                                      :disabled="up_loading"-->
                <!--                                                      class="mr-4 cursor-pointer mb-2 w-30">-->
                <!--                                                Zoom(1.5x)-->
                <!--                                            </a-button>-->
...
import {del_draw_nofinish} from "~/utils/api";
